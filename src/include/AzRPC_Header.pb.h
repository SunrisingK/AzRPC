...
#ifndef GOOGLE_PROTOBUF_INCLUDED_AzRPC_5fHeader_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_AzRPC_5fHeader_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_AzRPC_5fHeader_2eproto
...
struct TableStruct_AzRPC_5fHeader_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_AzRPC_5fHeader_2eproto;
namespace AzRPC {
class RpcHeader;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::AzRPC::RpcHeader* Arena::CreateMaybeMessage<::AzRPC::RpcHeader>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace AzRPC {
...
class RpcHeader final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:AzRPC.RpcHeader) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:AzRPC.RpcHeader)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_AzRPC_5fHeader_2eproto;
};
// ===================================================================
...
inline const std::string& RpcHeader::service_name() const {
  // @@protoc_insertion_point(field_get:AzRPC.RpcHeader.service_name)
...
void RpcHeader::set_service_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.service_name_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:AzRPC.RpcHeader.service_name)
}
inline std::string* RpcHeader::mutable_service_name() {
  std::string* _s = _internal_mutable_service_name();
  // @@protoc_insertion_point(field_mutable:AzRPC.RpcHeader.service_name)
  return _s;
}
...
inline std::string* RpcHeader::release_service_name() {
  // @@protoc_insertion_point(field_release:AzRPC.RpcHeader.service_name)
...
inline void RpcHeader::set_allocated_service_name(std::string* service_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:AzRPC.RpcHeader.service_name)
}
...
inline const std::string& RpcHeader::method_name() const {
  // @@protoc_insertion_point(field_get:AzRPC.RpcHeader.method_name)
...
void RpcHeader::set_method_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.method_name_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:AzRPC.RpcHeader.method_name)
}
inline std::string* RpcHeader::mutable_method_name() {
  std::string* _s = _internal_mutable_method_name();
  // @@protoc_insertion_point(field_mutable:AzRPC.RpcHeader.method_name)
  return _s;
}
...
inline std::string* RpcHeader::release_method_name() {
  // @@protoc_insertion_point(field_release:AzRPC.RpcHeader.method_name)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:AzRPC.RpcHeader.method_name)
}
...
inline uint32_t RpcHeader::args_size() const {
  // @@protoc_insertion_point(field_get:AzRPC.RpcHeader.args_size)
...
inline void RpcHeader::set_args_size(uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:AzRPC.RpcHeader.args_size)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_AzRPC_5fHeader_2eproto
